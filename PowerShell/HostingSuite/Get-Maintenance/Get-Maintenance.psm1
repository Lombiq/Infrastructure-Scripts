...
function Get-Maintenance
{
    ...
    (
        ...
        [Parameter(Mandatory = $true,
                   HelpMessage = "The hostname of the API endpoint that returns the maintenance status.
        ...
        [string] $Hostname = $(throw "You need to specify the API endpoint that returns the maintenance status."),
