...
function Find-NearestAzureDatacenter
{
    ...
    process
    {
        # This is list is not necessarily complete and depends on the intersection between the regions available to our
        # subscription and the regions where storage accounts can be created.
